...
// Favicon site logo
document.write('  <div> <a href="/" class="nav-branding"><img alt="Wood Badge Owl" width=35 src="./WoodBadgeOwl.svg"></a> </div>')
// Section title
document.write('  <div> <h2 id="siteTitle">KnotOwl</h2> </div>')
// Hamburger button using semantic HTML
document.write('  <div>')
// Button
